...
#### 2.核心价值： 本产品着眼于满足用户的不同需求，帮助用户在日常生活中了解更多关于艺术的知识，同时解决用户前往艺术场馆时的前提需求。
#### 3.用户痛点：
核心价值|用户痛点
--|:--:
...
#### 一分钟版本
##### 随着生活水平的提升，大众对文化底蕴的追求愈加强烈，本产品是专注于集知识输出与实时动态为一体的APP。首先，用户通过使用"识画"功能即可随时随地获取一幅画作的背景信息；其次，通过场馆的实时人流量反馈得知场馆当下的人流密度，再通过交通态势反馈得知场馆周边的实时路况，为用户选择是否在某一时间段前往某一艺术馆提供了实用信息，为用户的生活带来便捷的同时还有助于提升用户的体验感及满意度。

## 学习/实践心得
#### 通过这次API期末项目，个人在实践过程有以下几点思考：首先，想清楚比做出来更重要，虽然单凭构想具有局限性，但往往比盲目输出更有价值，我明白在项目实践之前就需要想好为什么做，如何做，然后再实施，并且这个过程可以反复几次；其次了解用户痛点后，我通过将需求拆分成功能点以确定产品的核心价值，在搜寻痛点的过程还需要把眼光放大，思考这是在什么场景下用户遇到一个什么样问题；期末项目能如愿实施，我还要特别感谢百度及高德开放平台的免费支持。
